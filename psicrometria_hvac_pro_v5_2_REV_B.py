# -*- coding: utf-8 -*-
"""
PSICROMETRIA HVAC PRO V6.1 INTERACTIVA
...
class App(tk.Tk):
    def __init__(self):
        super().__init__()
        self.title("PSICROMETRIA HVAC PRO V6.1 — CARTA PROFESIONAL")
    ...
    def build(self):
        ...
        ttk.Label(head,text="❄  PSICROMETRIA HVAC PRO V6.1",foreground="#064da8",font=("Segoe UI",19,"bold")).pack(side="left")
